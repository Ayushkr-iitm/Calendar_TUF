  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        wall: { DEFAULT: "hsl(var(--wall))", light: "hsl(var(--wall-light))" },
        paper: { DEFAULT: "hsl(var(--paper))", foreground: "hsl(var(--paper-foreground))" },
        ...
        "calendar-sunday": "hsl(var(--calendar-sunday))",
        sidebar: {
